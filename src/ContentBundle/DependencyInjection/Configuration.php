                ...
                ->arrayNode('blocks')
                    ...
                    ->children()
                        ...
                        ->arrayNode('form')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('view')->defaultValue('OpiferContentBundle:Block:Content/form.html.twig')->end()
                            ->end()
                        ->end()
                        ...
                        ->arrayNode('login')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('view')->defaultValue('OpiferContentBundle:Block:Content/login.html.twig')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
